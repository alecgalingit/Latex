"""
Script to fine-tune Llama in order to create a model which converts Latex code to a natural language input.
"""
import os
import torch
...
if __name__ == "__main__":
  ...
  dataset_loc = os.path.join(basedir, 'generated_data','chat_train.parquet')
  model, tokenizer = train(dataset_loc)
