"""
Fine-tunes Llama in order to create a model which converts Latex code to a natural language input. Training data is generated by generate_chat_dataset.py.
"""
import os
import torch
